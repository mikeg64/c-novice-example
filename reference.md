...
subtitle: Reference
---
## [Analyzing Patient Data](introduction.html)

*   Repeating actions with loops
*   Import a library into a program using `import libraryname`.
*   Use `variable = value` to assign a value to a variable in order to record it in memory.
*   Variables are created on demand whenever a value is assigned to them.
*   Use `printf something` to display the value of `something`.
...
*   Soting multipl values using arrays
...
## [Pointers and Arrays of Values](pointers.html)
...
## [Reading and Writing Files](files.html)

*   Functions and pointers.
*   Soting multipl values using arrays
*   Use `len(thing)` to determine the length of something that contains other values.

## [Using Libraries](libraries.html)
...
## [Building Bigger Programs](building.html)
...
:   A remark in a program that is intended to help human readers understand what is going on,
	...
	Comments in C are enclosed by the marks /* and */
